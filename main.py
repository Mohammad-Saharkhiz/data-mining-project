...
# # Hierarchical Clustering
# # Perform hierarchical clustering
# linked = linkage(df_scaled_np, method='ward')
#
# # Plot the dendrogram using seaborn
# plt.figure(figsize=(10, 6))
# dendrogram(linked, orientation='top', distance_sort='descending', show_leaf_counts=True)
...
#     'Accuracy': [accuracy_score(y_test_np, y_pred_dt), accuracy_score(y_test_np, y_pred_svm)],
#     'Precision': [precision_score(y_test_np, y_pred_dt), precision_score(y_test_np, y_pred_svm)],
#     'Recall': [recall_score(y_test_np, y_pred_dt), recall_score(y_test_np, y_pred_svm)],
#     'F1-Score': [f1_score(y_test_np, y_pred_dt), f1_score(y_test_np, y_pred_svm)]
# }
#
# results_df = pd.DataFrame(results)
# print(results_df)